...
(function () {
  ...
  Chart.defaults.color = "rgba(242,244,248,0.25)";
  Chart.defaults.borderColor = "rgba(242,244,248,0.05)";
    ...
    chartTemp = new Chart(document.getElementById("chart-temp"), {
      ...
      data: {
        ...
        datasets: [{
          ...
          backgroundColor: function(ctx) {
            ...
            if (!area) return "rgba(243,202,64,0.06)";
            var g = chart.ctx.createLinearGradient(0, area.top, 0, area.bottom);
            g.addColorStop(0, "rgba(243,202,64,0.15)");
      ...
      options: {
        ...
        scales: {
          ...
          y: {
            grid: { color: "rgba(242,244,248,0.04)" },
            ticks: {
        ...
        datasets: [
          {
            ...
            backgroundColor: function(ctx) {
              var chart = ctx.chart;
              var area = chart.chartArea;
              if (!area) return "rgba(87,115,153,0.06)";
              var g = chart.ctx.createLinearGradient(0, area.top, 0, area.bottom);
              g.addColorStop(0, "rgba(87,115,153,0.12)");
          ...
          },
          {
            label: "Light",
            data: [],
            borderColor: "rgba(242,244,248,0.5)",
            backgroundColor: function(ctx) {
              var chart = ctx.chart;
              var area = chart.chartArea;
              if (!area) return "rgba(242,244,248,0.04)";
              var g = chart.ctx.createLinearGradient(0, area.top, 0, area.bottom);
              g.addColorStop(0, "rgba(242,244,248,0.08)");
